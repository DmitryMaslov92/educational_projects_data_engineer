...
from lessons.stg.stg_settings_repository import EtlSetting, StgEtlSettingsRepository
...
class UsersDestRepository:
    ...
    def insert_users(self, conn: Connection, rank: UserObj) -> None:
    ...
    def load_users(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            for rank in load_queue:
                self.stg.insert_users(conn, rank)
