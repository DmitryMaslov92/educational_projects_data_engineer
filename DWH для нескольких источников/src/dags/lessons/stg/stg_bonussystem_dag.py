...
from lessons.stg.bonus_system_users_dag.users_loader import UsersLoader
from lessons.stg.bonus_system_events_dag.events_loader import EventsLoader
from lessons.stg.bonus_system_ranks_dag.ranks_loader import RankLoader
...
def origin_to_stg_bonussystem_dag():
    ...
    events_dict, users_dict, ranks_dict


stg_bonus_system_dag = origin_to_stg_bonussystem_dag()
